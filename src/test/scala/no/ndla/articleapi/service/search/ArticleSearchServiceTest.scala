...
class ArticleSearchServiceTest extends UnitSuite with TestEnvironment {
  ...
  test("all should return only articles of a given type if a type filter is specified") {
    ...
    articleSearchService.getHits(results.response, Language.DefaultLanguage, articleSearchService.hitToApiModel).head.id should be (8)
  ...
  test("That all returns all documents ordered by id ascending") {
    ...
    val hits = articleSearchService.getHits(results.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
  ...
  test("That paging returns only hits on current page and not more than page-size") {
    ...
    val hits1 = articleSearchService.getHits(page1.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
    val hits2 = articleSearchService.getHits(page2.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
  ...
  test("Searching with logical AND only returns results with all terms") {
    ...
    val hits1 = articleSearchService.getHits(search1.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
    ...
    val hits2 = articleSearchService.getHits(search2.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
    ...
    val hits3 = articleSearchService.getHits(search3.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
    ...
    val hits4 = articleSearchService.getHits(search4.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
  ...
  test("search in content should be ranked lower than introduction and title") {
    ...
    val hits = articleSearchService.getHits(search.response, Language.DefaultLanguage, articleSearchService.hitToApiModel)
  ...
  test("Search for all languages should return all articles in correct language") {
    ...
    val hits = articleSearchService.getHits(search.response, Language.AllLanguages, converterService.hitAsArticleSummaryV2)
  ...
  test("Search for all languages should return all languages if copyrighted") {
    ...
    val hits = articleSearchService.getHits(search.response, Language.AllLanguages, articleSearchService.hitToApiModel)
