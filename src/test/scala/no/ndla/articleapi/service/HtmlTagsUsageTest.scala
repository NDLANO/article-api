...
class HtmlTagsUsageTest extends UnitSuite with TestEnvironment {
  ...
  val article1 = ArticleInformation("1", Seq(ArticleTitle("test", Some("en"))), Seq(Article("<article><div>test</div></article>", None, Some("en"))), copyright, Seq(), Seq())
  val article2 = ArticleInformation("2", Seq(ArticleTitle("test", Some("en"))), Seq(Article("<article><div>test</div><p>paragraph</p></article>", None, Some("en"))), copyright, Seq(), Seq())
  val article3 = ArticleInformation("3", Seq(ArticleTitle("test", Some("en"))), Seq(Article("<article><img></img></article>", None, Some("en"))), copyright, Seq(), Seq())
