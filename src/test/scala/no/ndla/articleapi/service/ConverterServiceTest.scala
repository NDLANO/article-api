...
class ConverterServiceTest extends UnitSuite with TestEnvironment {
  ...
  test("That images are converted") {
    ...
    val expectedResult =
      s"""|<article>
          |<$resourceHtmlEmbedTag data-align="" data-alt="$sampleAlt" data-caption="" data-id="1" data-resource="image" data-size="fullbredde" data-url="http://localhost/image-api/v1/images/$newId" />
