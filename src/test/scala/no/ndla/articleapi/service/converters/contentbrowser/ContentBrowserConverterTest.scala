...
class ContentBrowserConverterTest extends UnitSuite with TestEnvironment {
  ...
  test("That Content-browser strings of type image are converted into HTML img tags") {
    ...
    val expectedResult =
      s"""|<article>
          |<$resourceHtmlEmbedTag data-align="" data-alt="$alt" data-caption="" data-id="1" data-resource="image" data-size="fullbredde" data-url="http://localhost/image-api/v1/images/$newId" />
