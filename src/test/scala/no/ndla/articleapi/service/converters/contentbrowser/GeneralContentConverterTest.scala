...
class GeneralContentConverterTest extends UnitSuite with TestEnvironment {
  ...
  val sampleNodeToConvert = NodeToConvert(Seq(ArticleTitle("title", Some("en"))), Seq(), "publicdomain", Seq(), Seq(), Seq(), "fagstoff", new Date(0), new Date(1), "ndalId54321", ArticleType.Standard)
