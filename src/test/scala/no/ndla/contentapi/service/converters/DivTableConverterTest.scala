...
class DivTableConverterTest extends UnitSuite {
  ...
  test("That divs with class 'ndla_table' is converted to table") {
    val initialContent = LanguageContent(nodeId, nodeId, "<article><div class=\"ndla_table another_class\">nobody builds walls better than me, believe me</div></article>", Some("en"), None)
  ...
  test("That divs with class 'ndla_table_row' is converted to tr") {
    val initialContent = LanguageContent(nodeId, nodeId, "<article><div class=\"ndla_table_row another_class\">My IQ is one of the highest - and you all know it!</div></article>", Some("en"), None)
  ...
  test("That divs with class 'ndla_table_cell' is converted to td") {
    val initialContent = LanguageContent(nodeId, nodeId, "<article><div class=\"ndla_table_cell another_class\">I am very highly educated</div></article>", Some("en"), None)
  ...
  test("That divs with class 'ndla_table_cell_content' is removed") {
    val initialContent = LanguageContent(nodeId, nodeId, "<article><div><div class=\"ndla_table_cell_content another_class\">in that wall we are going to have a big fat door</div></div></article>", Some("en"), None)
