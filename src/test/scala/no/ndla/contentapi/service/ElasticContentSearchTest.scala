...
class ElasticContentSearchTest extends UnitSuite with TestEnvironment with ElasticSugar {
  ...
  val content1 = ContentInformation("1", List(ContentTitle("Batmen er på vift med en bil", Some("nb"))), List(Content("Bilde av en <strong>bil</strong> flaggermusmann som vifter med vingene <em>bil</em>.", Some("nb"))), byNcSa, List(ContentTag("fugl", Some("nb"))), List())
  val content2 = ContentInformation("2", List(ContentTitle("Pingvinen er ute og går", Some("nb"))), List(Content("<p>Bilde av en</p><p> en <em>pingvin</em> som vagger borover en gate</p>", Some("nb"))), publicDomain, List(ContentTag("fugl", Some("nb"))), List())
  val content3 = ContentInformation("3", List(ContentTitle("Donald Duck kjører bil", Some("nb"))), List(Content("<p>Bilde av en en and</p><p> som <strong>kjører</strong> en rød bil.</p>", Some("nb"))), publicDomain, List(ContentTag("and", Some("nb"))), List())
