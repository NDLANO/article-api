...
case class ArticleInformation(
                               ...
                               @(ApiModelProperty@field)(description = "Page titles for this article") pageTitle: Seq[PageTitle],
...
case class VisualElement(
                          @(ApiModelProperty@field)(description = "The resource identifier") resource: String,
...
@ApiModel(description = "Description of a page title")
