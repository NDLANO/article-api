...
import no.ndla.articleapi.ComponentRegistry.{internController, articleController, articleControllerV2, resourcesApp, healthController, conceptController}
...
class ScalatraBootstrap extends LifeCycle {
  ...
  override def init(context: ServletContext) {
    ...
    context.mount(conceptController, "/article-api/v1/concepts", "concepts")
